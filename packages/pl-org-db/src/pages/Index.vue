<template>
	<Layout>
				...
				<div class="carousel-inner">
					<div class="carousel-item">
						<div class="card bg-dark flex-row-md">
							<img style="width: 300px; margin-right: 1px;" src="https://scontent-waw1-1.xx.fbcdn.net/v/t1.0-9/10527568_270698806472672_1974256423053975189_n.jpg?_nc_cat=108&_nc_sid=85a577&_nc_oc=AQn2ROu2OcNmjdBoc5b3WNYnHYfNxfpXixzk55nhh-Idw5_hUPNFkUDWK-NWrcHhFAQ&_nc_ht=scontent-waw1-1.xx&oh=72f48e4af288ffd50fa17a4437f3559d&oe=5EB59E68">
							<div>
								<h3 class="card-header">Zbigniew Kawalec</h3>
								<div class="card-body bg-white flex-grow-1">
									<p>Maecenas nec dapibus nisi. Morbi vitae dignissim ligula. Duis rhoncus, sapien vel blandit porttitor, velit elit mattis nisl, non pellentesque ipsum nisl eu quam. Proin vitae rhoncus orci. Duis condimentum lectus vel urna viverra laoreet. Vestibulum ligula leo, venenatis eu sapien blandit, fringilla ullamcorper tortor. Mauris ex neque, mollis nec eleifend a, pellentesque non urna. Cras accumsan convallis posuere.</p>
									<div class="flex-row">
										<a href="#" class="btn btn-dark"><i class="fa fa-facebook"></i></a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="carousel-item">
						<div class="card bg-dark flex-row-md">
							<img style="width: 300px; margin-right: 1px;" src="https://scontent-waw1-1.xx.fbcdn.net/v/t1.0-9/10527568_270698806472672_1974256423053975189_n.jpg?_nc_cat=108&_nc_sid=85a577&_nc_oc=AQn2ROu2OcNmjdBoc5b3WNYnHYfNxfpXixzk55nhh-Idw5_hUPNFkUDWK-NWrcHhFAQ&_nc_ht=scontent-waw1-1.xx&oh=72f48e4af288ffd50fa17a4437f3559d&oe=5EB59E68">
							<div>
								<h3 class="card-header">Przemysław Hinc</h3>
								<div class="card-body bg-white flex-grow-1">
									<p>Maecenas nec dapibus nisi. Morbi vitae dignissim ligula. Duis rhoncus, sapien vel blandit porttitor, velit elit mattis nisl, non pellentesque ipsum nisl eu quam. Proin vitae rhoncus orci. Duis condimentum lectus vel urna viverra laoreet. Vestibulum ligula leo, venenatis eu sapien blandit, fringilla ullamcorper tortor. Mauris ex neque, mollis nec eleifend a, pellentesque non urna. Cras accumsan convallis posuere.</p>
									<div class="flex-row">
										<a href="#" class="btn btn-dark"><i class="fa fa-facebook"></i></a>
					...
					<div class="carousel-item">
						<div class="card bg-dark flex-row">
							<div>
								<h3 class="card-header">Tomasz Moroń</h3>
								<div class="card-body bg-white flex-grow-1" style="padding: 14px;">
									<p>Vestibulum ligula leo, venenatis eu sapien blandit, fringilla ullamcorper tortor. Mauris ex neque, mollis nec eleifend a, pellentesque non urna. Cras accumsan convallis posuere.</p>
									<div class="flex-row">
										<a href="#" class="btn btn-dark"><i class="fa fa-facebook"></i></a>
									</div>
								</div>
		...
		<section id="wspieraj" class="container-fluid">
